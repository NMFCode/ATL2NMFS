				...
				namespace «namespace»
				{
				    class «mainClassName»
				    {
				        static void Main(string[] args)
				        {
							...
							var changePropagation = ChangePropagationMode.OneWay;
							«transformationName» synchronization = new «transformationName»(inputModelContainer, outputModelContainer);

							var context = synchronization.Synchronize<«inputModelContainerClassName», «outputModelContainerClassName»>(synchronization.SynchronizationRule<«transformationName».«mainRuleName»>(), ref inputModelContainer, ref outputModelContainer, direction, changePropagation);
